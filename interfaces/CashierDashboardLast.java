...
public class CashierDashboardLast extends javax.swing.JFrame {
    Connection conn;
    ResultSet rs;
   ...
   // float netPay=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, -4, 950, 550));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierDashboardLast.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashierDashboardLast().setVisible(true);
            }
        });
    }
